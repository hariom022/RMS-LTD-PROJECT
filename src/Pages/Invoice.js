    ...
    <Box sx={{ display: "flex" }}>
      ...
      <Typography
        ...
        <Box sx={{border:'2px solid black', mt:'80px', background:'#fff'}}>
          <Box sx={{display:'flex', justifyContent:'space-between', p:'10px 20px'}}>
      ...
      <Table sx={{ minWidth: 700 }} aria-label="spanning table">
        ...
        <Box sx={{display:'flex', justifyContent:'center', m:'20px 0px'}} className="btn">
            <Button className="approve-btn">Approve</Button>
            <Link>
            <Button className="reject-btn" onClick={()=>nevigate(-1)}>Reject</Button>
            </Link>
          </Box>
      </Box>
    </Box>
